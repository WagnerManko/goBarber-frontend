    ...
    <Container>
      <Header>
        <HeaderContent>
          ...
          <Profile>
            <img
              src="https://avatars3.githubusercontent.com/u/45788235?s=460&u=b34e046065e573b885808bcc1d5eb4f0d6e72994&v=4"
              alt={user.name}
            />
            <div>
              <span>Bem-vinda,</span>
              <Link to="/profile"><strong>Wagner Mengue</strong></Link>
            </div>
          </Profile>
      ...
      <Content>
        <Schedule>
          ...
          {isToday(selectedDate) && nextAppointment && (
            <NextAppointment>
              <strong>Atendinto a seguir</strong>
              <div>
                <img
